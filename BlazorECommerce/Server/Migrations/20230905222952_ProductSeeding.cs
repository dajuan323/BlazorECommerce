        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "La Planète des singes, known in English as Planet of the Apes in the US and Monkey Planet in the UK, is a 1963 science fiction novel by French author Pierre Boulle. It was adapted into the 1968 film Planet of the Apes, launching the Planet of the Apes media franchise.[", "https://upload.wikimedia.org/wikipedia/en/f/f1/LaPlan%C3%A8teDesSinges.jpg", 11.99m, "Planet of the Apes" }
                });
        }
